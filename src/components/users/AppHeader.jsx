...
const AppHeader = () => {
    ...
    return (
        <div>
            {
                user.token ?
                <Navbar expand="xl" style={{backgroundColor: '#f4f7fa'}} className="logged-header" collapseOnSelect>
                    <Container>
                            ...
                            <Nav className="ms-auto" activeKey={location.pathname}>
                                {
                                    privateNavItems.map((navItem, idx) => {
                                        if (navItem.onClick) {
                                            return (
                                                <Nav.Item className="hide-item" key={idx} onClick={navItem.onClick}>
                                ...
                                <NavDropdown
                                    ...
                                    title={
                                        (   
                                            <span>
                                                <Image roundedCircle={true} className="avatar me-2" src={require("../../assets/images/avatar.png")}/>
                                ...
                                >
                                    {
                                        user.user.role !== 0 && <NavDropdown.Item onClick={() => navigate("/admin")}>{user.user.role === 1 ? "Staff panel" : "Admin panel" }</NavDropdown.Item>
                                    }
                ...
                <Navbar expand="lg" style={{
                    backgroundColor: navbarType ? (navbarBgStatus ? "#D6E4F1" : "#f4f7fa") : "#D6E4F1",
                }} collapseOnSelect> 
                    <Container>
                        <LinkContainer to="/">
